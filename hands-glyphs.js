let currentChar = 'A';
        ...
        function initGrids() {
            createGrid(document.getElementById('uppercaseGrid'), uppercase);
            createGrid(document.getElementById('lowercaseGrid'), lowercase);
            createGrid(document.getElementById('numbersGrid'), numbers);
            createGrid(document.getElementById('specialGrid'), special);
        }
